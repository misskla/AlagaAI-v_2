  ...
  Future<void> _handleAuth() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (_isSignUp) {
          // SIGN UP FLOW
          // For child accounts, validate parent email first
          ...
          await _firestore.collection('users').doc(userCredential.user!.uid).set({
            ...
            // For child accounts, store parent reference
            if (widget.role == "Child") 'parentEmail': _parentEmailController.text.trim(),
          });
        } else {
          // SIGN IN FLOW
